...
var categoryTag = document.getElementById('categoryname_id')

function changeManufacturerName() {
    var valueCategory = manufacturerTag.value
    var categoryList = dataList[valueCategory]
...
var productNameTag = document.getElementById('productName_id')
